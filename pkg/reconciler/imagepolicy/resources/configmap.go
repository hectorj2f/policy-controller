...
// ClusterImagePolicy
func NewConfigMap(ns, name, cipName string, cip *webhookcip.ImagePolicy) (*corev1.ConfigMap, error) {
...
func CreatePatch(ns, name, cipName string, cm *corev1.ConfigMap, cip *webhookcip.ImagePolicy) ([]byte, error) {
	entry, err := marshal(cip)
	if err != nil {
		return nil, err
	}
